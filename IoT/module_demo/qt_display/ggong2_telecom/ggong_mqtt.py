...
class MqttThread(QThread):
    ...
    def __init__(self):
        ...
        self.cert_filepath = config["cert_filepath"]
        self.pri_key_filepath = config["pri_key_filepath"]
        self.ca_filepath = config["ca_filepath"]
        self.client_id = config["client_id"]
        self.topic_filter = config["topic_filter"]
        self.my_topic = config["my_topic"]
    ...
    def publish_message(self):
        ...
        print("Pub received with {}".format(repr(publish_completion_data.puback.reason_code)))
    ...
    def insert_message(self):
        ...
        try:
            connection = mysql.connector.connect(user=config["db_user"], password=config["db_password"], host=config["db_host"],
